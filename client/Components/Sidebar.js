...
export default function Sidebar({ userInfo, id }) {
    return (
        <div className='lg:w-[26vw] lg:dark:bg-gray-950 max-h-screen'>
            <Link href='/profile' className='max-lg:hidden flex lg:gap-2 items-center max-lg:justify-center lg:dark:bg-gray-900 lg:bg-gray-50 max-lg:dark:bg-green-900 py-2 px-3'>
                <img
                    ...
                    alt='Profile pic'
                />
                <p className='text-lg capitalize dark:text-white' title={userInfo?.name}>{userInfo?.name}</p> 
            </Link>
            ...
            <div className='h-[90vh] overflow-y-scroll [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] w-full bg-gray-100 dark:bg-gray-950'>
                <div className='lg:w-full flex gap-2 items-center dark:bg-gray-900 mt-0.5 py-1 px-2 max-lg:hidden'>
                    ...
                    <input
                        className='w-full outline-hidden p-2 dark:bg-gray-800 dark:text-white rounded-xl bg-gray-200'
                        type="text"
